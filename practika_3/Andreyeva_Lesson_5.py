...
#У пользователя есть 5 попыток угадать номер и цвет. (3 красный, 3 2)
#Если не угадали комбинацию, то вывести на экран правильную и продолжить игру.
#
import random
...
while i < 5:
    ...
    d = int(input("Введите цвет от 1 до 2 (1 - черный, 2 - красный): "))
    if a == c and b == d:
